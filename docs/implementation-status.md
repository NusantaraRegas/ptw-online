...
| Spesimen tanda tangan visual | Partial/Development | Admin dapat mengunggah PNG berversi; exact image/hash dibekukan pada evidence reviewer SO/Officer dan Manager, lalu dicetak bersama nama aktor dan waktu WIB. Bukan PSrE; Bagian 3/tanda tangan lapangan tetap hardcopy menunggu OPN-008 |
