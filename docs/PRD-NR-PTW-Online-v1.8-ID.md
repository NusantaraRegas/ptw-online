...
| FR-CLO-003 | Manager pemilik wilayah membuka task `AREA_CLOSE_VERIFICATION`, melihat evidence, lalu memilih **Tutup PTW** dengan verifikasi Bagian 10 terstruktur (nama Officer ≤ 100 karakter, area diinspeksi dan bersih, pekerjaan selesai, Manager setuju selesai, sistem inhibited dipulihkan, handback dan pengaman dipulihkan, hardcopy terbaca) atau **Minta tindak lanjut** dengan alasan. |
