...
- **Papan Operasi** menyediakan read-model monitoring wilayah untuk Administrator, PIC HSE, SO/Officer, dan Manager Pemilik Wilayah. Administrator melihat seluruh PTW non-draft di semua wilayah, termasuk status terminal seperti Ditutup, sedangkan role operasional lain tetap melihat Diterbitkan, Ditangguhkan, dan permintaan penutupan sesuai scope lokasinya. Metrik Diterbitkan, Ditangguhkan, segera berakhir dalam 24 jam, dan penutupan dihitung di database setelah scope diterapkan; daftar dapat dicari, difilter, dipaginasi dengan pilihan 10/25/50/100 item per halaman, diperbarui otomatis, dan dibuka ke detail PTW. Beranda Administrator juga merangkum dan menampilkan aktivitas PTW non-draft; Sponsor tanpa role operasional ditolak server-side;
