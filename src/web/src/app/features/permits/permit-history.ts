...
export class PermitHistory {
  ...
  protected eventLabel(eventType: string): string {
    const labels: Record<string, string> = {
      ...
      hse_validation_completed: 'Validasi HSE selesai',
      hse_validation_escalated: 'Validasi HSE dieskalasikan',
      permit_issued: 'PTW disetujui dan diterbitkan',
      permit_suspended: 'PTW ditangguhkan; pekerjaan harus berhenti',
      suspension_resolved: 'Penangguhan diselesaikan',
      signed_field_copy_uploaded: 'Signed field copy diunggah',
      closure_requested: 'Verifikasi penutupan diminta',
      closure_evidence_replacement_requested: 'Penggantian bukti penutupan diminta',
