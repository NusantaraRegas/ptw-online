...
export class PermitHistory {
  ...
  protected eventLabel(eventType: string): string {
    const labels: Record<string, string> = {
      ...
      work_period_opened: 'PTW diterbitkan dan periode kerja dimulai',
      permit_issued: 'PTW diterbitkan dan periode kerja dimulai',
      permit_validation_endorsed: 'Validasi disahkan',
      hsse_validation_completed: 'Validasi HSSE selesai',
      suspension_requested: 'Sponsor meminta penangguhan; hak kerja dihentikan',
      suspension_approved: 'Penangguhan disetujui PIC pemilik area',
      permit_resumed: 'Penangguhan diselesaikan',
      completion_declared: 'Sponsor menyatakan pekerjaan selesai',
      completion_confirmed: 'Penyelesaian pekerjaan dikonfirmasi',
      completion_confirmations_completed: 'Seluruh konfirmasi penyelesaian lengkap',
