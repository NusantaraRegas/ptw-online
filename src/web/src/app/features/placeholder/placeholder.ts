...
const styles = [
  `section{padding:60px;max-width:720px;text-align:center}section>span{width:52px;height:52px;display:grid;place-items:center;margin:0 auto 15px;border-radius:14px;color:var(--nr-blue-dark);background:var(--nr-blue-soft);font-size:24px}section h2{font-size:16px;color:var(--nr-ink)}section p{max-width:520px;margin:0 auto;color:var(--nr-muted);font-size:11px;line-height:1.7}`,
];
...
export class OperationsPage {
  title = 'Papan Operasi';
  description =
    'Visibilitas Diterbitkan, permintaan penangguhan, segera kedaluwarsa, dan konfirmasi penyelesaian.';
  icon = '◉';
}
