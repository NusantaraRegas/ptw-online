    ...
    public static PermitResponse ToResponse(this StoredPermit stored)
    {
        ...
        return new PermitResponse(
            ...
            new PermitWorkflowResponse(
                ...
                new AreaOperationsReviewResponse(
                    permit.AreaOperationsReview is not null,
                    permit.AreaOperationsReview?.ActorId,
                    permit.AreaOperationsReview?.ActorName,
                    permit.AreaOperationsReview?.ActorPosition,
                    permit.AreaOperationsReview?.AuthorizationId,
                    permit.AreaOperationsReview?.ConditionCodes ?? [],
                    permit.AreaOperationsReview?.OtherConditionDetail,
                    permit.AreaOperationsReview?.Statement,
                    permit.AreaOperationsReview?.ReviewedAt),
                ...
                new PermitClosureResponse(
                    ...
                    permit.ClosureDecision?.OfficerName,
                    permit.ClosureDecision?.WorkAreaInspectedAndClean ?? false,
                    permit.ClosureDecision?.WorkCompleted ?? false,
                    permit.ClosureDecision?.ManagerAgreesWorkCompleted ?? false,
                    permit.ClosureDecision?.InhibitedSystemsRestored ?? false,
                    permit.ClosureDecision?.AreaHandedBackAndSafeguardsRestored ?? false,
                    permit.ClosureDecision?.EvidenceReadable ?? false)),
            stored.ETag);
    }
